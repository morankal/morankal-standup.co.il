...
export default function Testimonials() {
  ...
  const testimonials = [
    ...
    {
      text: 'היה מושלם! הזמנו את מורן ליומולדת 9, אחרי שחיפשנו המון זמן הפעלה בוגרת יותר שתתאים לגיל הזה ושתהיה בראש אחר. הילדים עפו עליו ולא הפסיקו לצחוק (וגם אנחנו 😉). ידע איך לזרום עם הילדים וגם איך להחזיק אותם בתוך ההפעלה עם המון סבלנות ומקצועיות. החוגגת היתה בשמיים ונהנתה מכל רגע (כבר מתכננת את הבת מצווה עם הפעלה נוספת 🙂) ממליצים בחום ',
      name: 'אתי',
      event: 'יום הולדת 9'
    },
    {
